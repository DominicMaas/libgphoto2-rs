...
pub type GPContextErrorFunc =
    extern "C" fn(context: *mut GPContext, text: *const c_char, data: *mut c_void);

pub type GPContextStatusFunc =
    extern "C" fn(context: *mut GPContext, text: *const c_char, data: *mut c_void);

pub type GPContextMessageFunc =
    extern "C" fn(context: *mut GPContext, text: *const c_char, data: *mut c_void);

pub type GPContextQuestionFunc = extern "C" fn(
    context: *mut GPContext,
    text: *const c_char,
    data: *mut c_void,
) -> GPContextFeedback;

pub type GPContextCancelFunc =
    extern "C" fn(context: *mut GPContext, data: *mut c_void) -> GPContextFeedback;

pub type GPContextProgressStartFunc = extern "C" fn(
    context: *mut GPContext,
    target: c_float,
    text: *const c_char,
    data: *mut c_void,
...
pub type GPContextProgressUpdateFunc =
    extern "C" fn(context: *mut GPContext, id: c_uint, current: c_float, data: *mut c_void);

pub type GPContextProgressStopFunc =
    extern "C" fn(context: *mut GPContext, id: c_uint, data: *mut c_void);
...
extern "C" {
    ...
    pub fn gp_context_set_idle_func(
        context: *mut GPContext,
        func: GPContextIdleFunc,
        data: *mut c_void,
    );

    pub fn gp_context_set_progress_funcs(
        context: *mut GPContext,
    ...
    pub fn gp_context_set_error_func(
        context: *mut GPContext,
        func: GPContextErrorFunc,
        data: *mut c_void,
    );

    pub fn gp_context_set_status_func(
        context: *mut GPContext,
        fun: GPContextStatusFunc,
        data: *mut c_void,
    );

    pub fn gp_context_set_question_func(
        context: *mut GPContext,
        func: GPContextQuestionFunc,
        data: *mut c_void,
    );

    pub fn gp_context_set_cancel_func(
        context: *mut GPContext,
        func: GPContextCancelFunc,
        data: *mut c_void,
    );

    pub fn gp_context_set_message_func(
        context: *mut GPContext,
    ...
    pub fn gp_context_progress_start(
        context: *mut GPContext,
        target: c_float,
        format: *const c_char,
        ...
